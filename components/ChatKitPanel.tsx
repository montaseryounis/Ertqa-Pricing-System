      ...
      prompts: [
        {
          label: 'هدايا موظفين',
          prompt:
            'أريد تسعير هدية مخصصة لموظفي الشركة. ما الخيارات المتاحة وكم السعر التقريبي؟',
        },
        {
          label: 'جوائز كريستال',
          prompt:
            'كم تكلفة تصميم وتصنيع جائزة كريستال مخصصة للحفل السنوي؟',
        },
        {
          label: 'حفل تخرج',
          prompt:
            'أحتاج عرض سعر لحفل تخرج: 500 هدية تذكارية بتغليف فاخر.',
        },
        {
          label: 'خيارات التغليف',
          prompt: 'ما هي خيارات التغليف المتاحة وتكلفة كل منها؟',
        },
      ],
    },
    composer: {
